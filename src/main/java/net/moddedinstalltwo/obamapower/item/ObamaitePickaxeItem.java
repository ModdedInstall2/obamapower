...
public class ObamaitePickaxeItem extends PickaxeItem {
	public ObamaitePickaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Tears through stone. Makes mining easy - \"easy\" being far too weak a term."));
	}
